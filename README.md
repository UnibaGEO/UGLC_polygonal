...
- <b> OLD DATASET: </b> the contents of this field represent the name of the native dataset used into the UGLC creation:
    ...
    | [07_UGS](https://gis.utah.gov/data/geoscience/landslides/)                                                                                                                               | Utah landslide Inventory polygons                                                  | 2381        | [LICENSE](https://gis.utah.gov/about/policy/license-disclaimer/)                      | free      | :heavy_check_mark:    |
